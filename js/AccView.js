...
(function (exports) {
    ...
    AccViewManager.prototype = {
        ...
        onMeasure() {
    		...
    		this.mYScale = this.canvas.height/255;

			this.mYOffset = this.canvas.height * 0.05;
        ...
        onAlivePacket(timeSampleCount, packet) {
			...
			if (len > 0) {
				...
				for (var i = 0; i < len; i+=3) {
                    ...
                    console.log("Three-way: " + accBuffer[startIndex+i] +
                accBuffer[startIndex+i+1] + accBuffer[startIndex+i+2]);
				}
                this.onMeasure();
				this.onDraw();
			}
